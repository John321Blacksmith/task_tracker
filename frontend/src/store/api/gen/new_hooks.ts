...
export type PostSimpleTasksApiResponse = /** status 201  */ SimpleTaskForm;
export type PostSimpleTasksApiArg = {
  simpleTaskForm: SimpleTaskForm;
};
export type GetSimpleTasksByIdApiResponse = /** status 200  */ SimpleTaskRead;
export type GetSimpleTasksByIdApiArg = {
  /** A unique integer value identifying this Simple Tasks. */
  id: number;
};
export type PutSimpleTasksByIdApiResponse = /** status 200  */ SimpleTaskForm;
export type PutSimpleTasksByIdApiArg = {
  /** A unique integer value identifying this Simple Tasks. */
  id: number;
  simpleTaskForm: SimpleTaskForm;
};
export type PatchSimpleTasksByIdApiResponse = /** status 200  */ SimpleTaskForm;
